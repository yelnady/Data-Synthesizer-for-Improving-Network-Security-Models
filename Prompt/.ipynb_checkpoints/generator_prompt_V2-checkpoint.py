...
ck = torch.load('lightning_logs/version_21/checkpoints/epoch=399-step=153199.ckpt')['state_dict']
...
#         print(datapoint[None,:n_seed].shape) # torch.Size([1, 1, 9])
        ...
        if (n%1000==0):
            np.savez('npz_transformer_prompt_V2',X=generated_dataset_X,masks= resulted_masks,Y=generated_dataset_Y)
