...
class TimeSeriesTransformer(nn.Module):
    ...
    def __init__(self, n_features=1, d_model=200, n_heads=8, n_hidden=200, n_layers=6, dropout=0.5):
        super().__init__()
...
model.load_state_dict(torch.load('WWT_weights'))
model.eval()
...
np.savez('WWT_generated',X=final_dataset_class_X)
