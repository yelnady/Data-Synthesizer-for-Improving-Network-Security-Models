...
ck = torch.load('lightning_logs/version_63/checkpoints/epoch=399-step=76799.ckpt')['state_dict']
...
#                 print(S,datapoint_len)
        ...
        if ((n+1)%1000==0):
             np.savez('npz_transformer_flags1_V7',X=generated_dataset_X,masks= resulted_masks,Y=generated_dataset_Y)
