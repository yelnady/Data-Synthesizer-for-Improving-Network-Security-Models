...
class TimeSeriesTransformer(nn.Module):
    ...
    def __init__(self, n_features=10, d_model=256, n_heads=8, n_hidden=256, n_layers=8, dropout=0.1):
        super().__init__()
...
model.load_state_dict(torch.load('W_transformer_flags1_V5'))
model.eval()
print()
...
#                 print(S,datapoint_len)
        ...
        if ((n+1)%1000==0):
             np.savez('npz_transformer_flags1_V5',X=generated_dataset_X,masks= resulted_masks,Y=generated_dataset_Y)
